...
String operator+( String lhs, const __FlashStringHelper *rhs ) { lhs += rhs; return lhs; }
String operator+( String lhs, int rhs )                 { lhs += rhs; return lhs; }
String operator+( String lhs, unsigned int rhs )        { lhs += rhs; return lhs; }
String operator+( String lhs, long rhs )                { lhs += rhs; return lhs; }
String operator+( String lhs, unsigned long rhs )       { lhs += rhs; return lhs; }
String operator+( String lhs, long long rhs )           { lhs += rhs; return lhs; }
String operator+( String lhs, unsigned long long rhs )  { lhs += rhs; return lhs; }
String operator+( String lhs, float rhs )               { lhs += rhs; return lhs; }
String operator+( String lhs, double rhs )              { lhs += rhs; return lhs; }
