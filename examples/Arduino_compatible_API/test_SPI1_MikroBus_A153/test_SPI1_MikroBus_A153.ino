/** SPI1 (MikroBus SPI) loopback test for FRDM-MCXA153
 *
 *  SPI1 is a plain SPI instance on the MikroBus header's MOSI/MISO/SCK/CS
 *  pins (P1_0/P1_2/P1_1/P1_3), independent of SPI (D10-D13). Backed by its
 *  own peripheral (LPSPI0, vs. SPI's LPSPI1 -- this chip only has these
 *  two LPSPI instances total), so both can be used in the same sketch.
 *
