/** Release check 06: the EEPROM library -- no wiring, so it sits in the
 *  0n group (see examples/release_check/README.md for the numbering).
 *
 *  Mirrors examples/Arduino_compatible_API/test_EEPROM exactly -- edit
 *  that one, then copy it here.
 *
 *  Checks the API, and that what was written is still there
