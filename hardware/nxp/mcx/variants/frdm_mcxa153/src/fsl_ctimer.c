...
/* This SDK drop's fsl_common_arm.h predates the MSDK_REG_SECURE_ADDR helper
 * (TrustZone alias-address macro added in a later SDK version); it is a
 * no-op outside CMSE secure builds, which this project doesn't use. */
